...
final class AddFriendCell: UITableViewCell {
    ...
    private enum Constants {
        ...
        enum AddFriendLabel {
            static let text: String = "Add friend..."
    ...
    private let addFriendLabel: UILabel = UILabel()
    ...
    private func configureAddFriendLabel() {
        wrap.addSubview(addFriendLabel)
        
        addFriendLabel.text = Constants.AddFriendLabel.text
        addFriendLabel.textColor = Constants.AddFriendLabel.textColor
        addFriendLabel.textAlignment = Constants.AddFriendLabel.textAlignment
        addFriendLabel.numberOfLines = Constants.AddFriendLabel.numberOfLines
    }
    ...
    private func configureStack() {
        ...
        stack.addArrangedSubview(addFriendLabel)
