...
final class AddFriendViewController: UIViewController {
    ...
    private enum Constants {
        ...
        enum NavBar {
            static let title: String = "Add friend"
        ...
        enum InstructionLabel {
            static let text: String = "Your friend will receive an invitation"
            static let textColor: UIColor = .white
    ...
    // MARK: - Properties
    private var interactor: AddFriendBusinessLogic
    ...
    @objc private func sendButtonPressed() {
        ...
        interactor.sendFriendRequest(AddFriendModels.SendFriendRequest.Request(email: email))
    }
