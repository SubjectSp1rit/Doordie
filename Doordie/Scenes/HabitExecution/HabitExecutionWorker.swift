...
final class HabitExecutionWorker {
    // MARK: - Constants
    ...
    // MARK: - Methods
    func deleteHabit(habit: HabitModel, completion: @escaping (Bool, String) -> Void) {
        ...
        let task = URLSession.shared.dataTask(with: request) { _, response, error in
            ...
            completion(true, "Привычка успешно удалена")
        }
        task.resume()
    }
